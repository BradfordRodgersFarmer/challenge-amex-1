...
const Person = ({ index }) => {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(Name_1.default, { index: index }),
        react_1.default.createElement("p", null, person.email),
        react_1.default.createElement("p", null, person.address),
        react_1.default.createElement("p", null, person.balance),
        react_1.default.createElement("p", null, person.created)));
};
